...
- An Android device that:
  - Runs a **non-odexed rom** based on Android version 1.5 through 8.1.
...
- Hooks (required): these are simple adapters to hook all versions of Android from 1.5 Cupcake to 8.1 Oreo. (See [patch](https://github.com/Lanchon/haystack/tree/master/patches-src/sigspoof-hook-4.1-6.0/services.jar).)
